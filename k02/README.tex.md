...
```
Likelihood for A：L_1: 0.000006

Likelihood for B: L_2: 0.000002
```

## 修正履歴
[comment #20200709]
- ソースコードの説明と出力結果を記入してください. 
- l.45 にミスがあります. (L1= になっています)
- 入力させている`var`の値は, l.41やl.44で標準偏差として利用しているようです. varは分散なので, 名前を変更するか, 分散を入力させて処理の中で分散から標準偏差を求めて使用するかのどちらかにしてください. 
